    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 6:
                ...
                printf(YELLOW "Enter number: " RESET);
                n = safeIntInput(INT_MIN, INT_MAX);
                getchar();
            ...
            case 14:
                ...
                min = safeIntInput(INT_MIN, INT_MAX);
                printf(YELLOW "Enter max: " RESET);
                max = safeIntInput(INT_MIN, INT_MAX);
                getchar();
            ...
            case 15:
                ...
                for (int i = 0; i < n; i++) {
                    printf("  [%d]: ", i + 1);
                    arr[i] = safeIntInput(INT_MIN, INT_MAX);
                }
                getchar();
            ...
            case 21:
                ...
                for (int i = 0; i < M1.n; i++) {
                    for (int j = 0; j < M1.p; j++) {
                        printf("  [%d][%d]: ", i, j);
                        M1.data[i][j] = safeIntInput(INT_MIN, INT_MAX);
                    }
                }
                ...
                for (int i = 0; i < M2.n; i++) {
                    for (int j = 0; j < M2.p; j++) {
                        printf("  [%d][%d]: ", i, j);
                        M2.data[i][j] = safeIntInput(INT_MIN, INT_MAX);
                    }
                }
                getchar();
            ...
            case 24:
                ...
                for (int i = 0; i < 2; i++) {
                    for (int j = 0; j < 2; j++) {
                        printf("  [%d][%d]: ", i, j);
                        A[i][j] = safeIntInput(INT_MIN, INT_MAX);
                    }
                }
                getchar();
